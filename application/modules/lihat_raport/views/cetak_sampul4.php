...
<body>
	<table>
		<tr>
			...
			<td style="text-align: center"><b>Rapot SMK MANBAUL ULUM<br>
			 TSANAWIYAH NEGERI Bekasi<br></b>
			<span style="font-size: 10pt">Alamat : Sumoroto, Bekasi, Samigaluh, Kulon Progo. <br>
			Telp :997979| Web : http://smkmu/</span>
			</td>
		</tr>
		...
		<tr><td colspan="2">
			...
			<table width="100%">
				...
				<tr><td>12.</td><td>Ijazah MTS/SMP / Paket A</td><td>:</td><td></td></tr>
				<tr><td></td><td>a. Nomor</td><td>:</td><td><?php echo $ds['ijazah_no']; ?></td></tr>
				<tr><td></td><td>b. Tahun</td><td>:</td><td><?php echo $ds['ijazah_thn']; ?></td></tr>
				<tr><td>13.</td><td colspan="3">Surat Keterangan Hasil Ujian Akhir Sekolah Berstandar Nasional (UASBN) MTS/SMP / Paket A</td></tr>
