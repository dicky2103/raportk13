...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama </td><td width="1%">:</td><td width="39%" class="tbl">MTsN Bekasi</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat </td><td>:</td><td class="tbl">Sumoroto, Bekasi, Samigaluh</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Bekasi, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala MTs Negeri Bekasi <br>
							<br><br><br><br>
